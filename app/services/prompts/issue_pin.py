...
[톤 규칙]
- 한줄요약형: 본문 1문장 100자 내외
- 상황설명형: 본문 250~350자(약 300자), 상황 중심
- 개선요청형: 본문 250~350자(약 300자), 부탁/제안 중심
- 긴급요청형: 본문 250~350자(약 300자), 빠른 확인 필요성 강조, 과장 금지, 이모지 금지
- 불편호소형: 본문 250~350자(약 300자), 체감 불편 + 절제된 감정 표현
